        ...
        <div className="video-section container position-relative">
          ...
          >
            ...
            <p className="long-content text-center text-white m-0 w-md-50">
              ...
              your operational and sustainability goals. up in the landfill.
              Eden Infinity works with trusted partners to turn that waste into
              energy, which is then allocated back to your business account.
            </p>

            <div
              className="video-icon-2 position-relative"
            ...
            <div className="col-md-4">
              <div id="services-header p-0">
                ...
                <h4 className="text-start">
                  We know how to keep our clients’ energy costs low and carbon
                  footprints small. We have created services which help them to
                  ...
                  <Accordion.Item eventKey={index.toString()} key={service.id}>
                    ...
                    <Accordion.Body>
                      ...
                      <div
                        ...
                        onClick={() => handleUpdateContent(service)}
                      >
                        <h5
        ...
        <div className="row hero-about-text">
          <div className="col-md-6 pe-5">
            ...
            <p className="long-content py-4">
              Building Eden was never just about the service; it was about the
              people behind it. Mark has curated a team of some of the best
              professionals in the industry, each bringing deep expertise and a
              commitment to doing things properly. From client-facing energy
              consultants to the operational team behind the scenes, Eden is
              built on knowledge, precision, and care at every level.
            </p>
