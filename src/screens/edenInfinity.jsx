...
const EdenInfinity = () => {
    ...
    const slides = [
        {
            title: "Hospitality",
            description: "Optimize energy efficiency in hotels and restaurants while maintaining guest comfort.",
            icon: images.icon1,
        },
        {
            title: "Breweries",
            description: "Improve sustainability in brewing with smart energy and water management.",
            icon: images.icon2
        },
        {
            title: "Corporate",
            description: "Reduce operational costs with intelligent energy solutions for offices and retail spaces.",
            icon: images.icon3
        },
        {
            title: "Real Estate",
            description: "Support smart, sustainable housing developments with advanced energy management.",
            icon: images.icon4
        },
        {
            title: "Hospitality",
        ...
        <div id="insights">
            ...
            <div className='infinity-video-section'>
                ...
                <div className='top-hero container'>
                    ...
                    <img src={images.infinity_logo} alt="logo" className="infinity-logo img-fluid" />
                ...
                <div className='container d-flex flex-column align-items-center justify-content-center'>
                    ...
                    <p className="dark-text title-big-medium text-lineheight">Transforming Energy Solutions</p>

                    <p className="long-content text-center m-0">The World is changing, Business and Consumers are becoming more aware about the importance of being “Sustainable”. This can be difficult and expensive, but there is a growing expectation that “Business” also does something to help the planet. Several organizations are already taking this onboard and are trying their best to deploy a more environmentally friendly policy. If this is already happening in your business, then great, but now you could do more.</p>
                </div>
                ...
                <div className='row container'>
                    <div className="col-md-4">
                        <din className="card-top">
                            ...
                            <p className="long-content text-center">All organisations produce waste, this is collected and taken to landfill with a potential impact on the environment.</p>
                        </din>
                    </div>
                    <div className="col-md-4">
                        <din className="card-top">
                            ...
                            <p className="long-content text-center">Eden works with its partners to generate power from this waste and ensure that this power is allocated to your business account.</p>
                        </din>
                    </div>
                    <div className="col-md-4">
                        <din className="card-top">
                            ...
                            <p className="long-content text-center">This allows your organisation to support the generation of your own power, EDEN Infinity provides you with a greener footprint on this planet.</p>
                        </din>
                    </div>
                </div>

                <div className='section-space'>
                    <Btn>Transform your buisness today</Btn>
                </div>
            ...
            <div className='sectors'>
                <div className="container chat-section">
                    ...
                    <p className="dark-text title text-start text-normal title-big-medium mb-0">Tailored Solutions for<br></br>
                        Diverse Sectors</p>
                </div>
                            ...
                            <div className="flower-features">
                                <div className="feature-box-outer">
                                    <div className='feature-box top-left-radius'>
                                        <img src={images.heart} alt="feature-box-icon" className="feature-box-icon" />
                                        <p>Save Effort</p>
                                    </div>
                                    <div className='feature-box feature-box-green top-right-radius'>
                                        <img src={images.time} alt="feature-box-icon" className="feature-box-icon" />
                                        <p>Save Time</p>
                                    </div>
                                    <div className='feature-box feature-box-green bottom-left-radius'>
                                        <img src={images.check} alt="feature-box-icon" className="feature-box-icon" />
                                        <p>Fully Transparent</p>
                                    </div>
                                    <div className='feature-box bottom-right-radius'>
                                        <img src={images.money} alt="feature-box-icon" className="feature-box-icon" />
                                        <p>Some Money</p>
                                    </div>
                                </div>

                                <div className="infinity-center">
                                    <img src={images.infinity_logo_transparent} alt="feature-box-icon" />
                                </div>
                            </div>
                        </div>
                                    ...
                                    <Swiper
                                        ...
                                        {slides.map((slide, index) => (
                                            <SwiperSlide key={index} className='slider-sector'>
                                                <div style={{ backgroundColor: Math.floor(index / 2) % 2 === 1 && index % 2 === 0 ? "#2f98d0" : "#4b6984" }} className="slider-sector-item">
                                                    ...
                                                    <p className="long-content-medium text-white">{slide.description}</p>
                                                </div>
                                            </SwiperSlide>
                                        ))}
                                    </Swiper>
            ...
            <section id="why-us" className="container px-0">
                <div className="row hero-about-text">
                    ...
                    <div className="col-md-6 ps-5">
                        ...
                        <p className="dark-text title text-start title-big text-lineheight">From SMEs to Industry Leaders, We've Got You Covered</p>
                        <p className="long-content py-4">Eden Utilities is proud to work alongside a number of key clients, ranging from smaller SME businesses, all the way through to very large energy consumers. Our aim is to deliver an open, honest, and fully transparent approach at all times. We treat each client we work with as a partner and look to create solid, long-term relationships built on trust</p>
